...
void logMsg(const char* msg) {
  ...
  void TurnR(int velocidade){//Função que faz o robô virar
    ...
    if (cmd == 's') { fase = 0; stepPos = 0; ResetToNeutral(); set_state(fsm, Aranha_em_pe);
      logMsg("Estado em pé.");
      logMsg("Comandos disponiveis: ");
      logMsg(" 'd' - Deitar");
      logMsg(" 'w' - Andar");
      logMsg(" 'l' - Virar à esquerda");
      logMsg(" 'r' - Virar à direita");
      return; 
      }
    ...
    switch (fsm.state) {
      ...
      case Aranha_velocidade_deitar:
        if (cmd != 0) {
          if (cmd == '1' || cmd == '2' || cmd == '3') {
            ...
            logMsg("Velocidade inválida!Escolha uma velocidade para deitar entre 1 e 3.");
          }
        }
        break;
      ...
      case Aranha_velocidade_andar:
        if (cmd != 0) {
          if (cmd == '1' || cmd == '2' || cmd == '3') {
            ...
            logMsg("Estado - Robô a andar");
            logMsg("Pode enviar o comando 'l' ou 'r' para parar de andar e rodar para a esquerda ou direita!");
       ...
       case Aranha_velocidade_rodardireita:
        if (cmd != 0) {
          if (cmd == '1' || cmd == '2' || cmd == '3') {
            ...
            logMsg("Estado - Robô a rodar para a direita");
            logMsg("Para parar o robô, utilize a tecla 's'.");
          }
          else {
            logMsg("Velocidade inválida!Escolha uma velocidade entre 1 e 3.");
        ...
        if (cmd != 0) {
          if (cmd == '1' || cmd == '2' || cmd == '3') {
            ...
            logMsg("Estado - Robô a rodar para a esquerda.");
            logMsg("Para parar o robô, utilize a tecla 's'.");
          }
          else {
            logMsg("Velocidade inválida!Escolha uma velocidade entre 1 e 3.");
      ...
      case Aranha_em_pe:
        if (cmd == 'd') {     // d no serial monitor faz com que a aranha deite
          ...
          logMsg("Escolha a velocidade para deitar o robô entre 1 e 3.");
        }
        ...
        if(cmd=='l'){
          ...
          logMsg("Escolha a velocidade para rodar para a esquerda entre 1 e 3.");
        }
        if(cmd=='r'){
          set_state(fsm,Aranha_velocidade_rodardireita);
          logMsg("Escolha a velocidade para rodar para a direita entre 1 e 3.");
        }
        break;
      ...
      case Aranha_a_deitar:
        ...
        logMsg("Estado - Aranha deitada");
        logMsg("Envie 'l' para levantar a aranha.");
        break;
